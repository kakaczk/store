...
<meta http-equiv="pragma" content="no-cache">
	<meta http-equiv="Cache-Control" content="no-cache,must-revalidate">
		...
		<link type="text/css" rel="stylesheet"
			href="http://static.sundiromall.com/css/regist.personal.css" />
		<link type="text/css" rel="stylesheet"
			href="http://static.sundiromall.com/css/passport.base.css" />
		<script type="text/javascript"
			src="http://static.sundiromall.com/js/jquery-1.2.6.min.js"></script>
</head>
<body>
	<script type="text/javascript">
function login() {
...
function addToFavorite() {
	...
	<div class="w" id="logo">
		<div>
			<a href="http://www.sundiromall.com/"> <img
				src="http://static.sundiromall.com/images/taotao-logo.gif" alt="京东商城" width="170" height="60" />
			</a> <b></b>
		</div>
	</div>
		...
		<div class="mt">
			...
			<div class="extra">
				...
				<a class="flk13"
					...
					href="http://sso.sundiromall.com/login.html" class="flk13">登录</a></span>
			</div>
		</div>
		<div class="mc">
			<form id="personRegForm" method="POST" onsubmit="return false;">
				...
				<div class="phone">
					<img width="180" height="180" src="http://static.sundiromall.com/images/phone-bg.jpg">
				</div>
				<span class="clr"></span>
			</form>
		</div>
	...
	<script type="text/javascript" src="http://static.sundiromall.com/js/register/jd.lib.js"></script>
	<script type="text/javascript" src="http://static.sundiromall.com/js/register/jdThickBox.js"></script>
	<script type="text/javascript" src="http://static.sundiromall.com/js/register/jdValidate.js"></script>
	<script type="text/javascript" src="http://static.sundiromall.com/js/register/jdValidate.emReg.js"></script>
	<script type="text/javascript"
		src="http://static.sundiromall.com/js/register/jdValidate.regSuccess.js"></script>
