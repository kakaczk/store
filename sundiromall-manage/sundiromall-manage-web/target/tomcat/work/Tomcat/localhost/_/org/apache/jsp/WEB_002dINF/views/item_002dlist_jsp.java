 ...
 * Generated at: 2016-12-01 02:14:06 UTC
...
public final class item_002dlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        \t\t\t// 加载商品类目名称,替换类目名称,回显\r\n");
      out.write("        \t\t\t$.getJSON('/rest/item/cat/'+data.cid,function(_data){\r\n");
      out.write("        \t\t\t\t$(\"#categoryName\").html(_data.name);\r\n");
      out.write("        \t\t\t});\r\n");
      out.write("        \t\t\t//向回调数据中添加priceView的值\r\n");
      ...
      out.write("\t\t\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\t\t\t200 : function(data_param) {\r\n");
      out.write("\t\t\t\t\t\t\t\t$(\"#itemeEditForm .params\").show();\r\n");
      out.write("\t\t\t\t\t\t\t\t$(\"#itemeEditForm [name=itemParams]\").val(data_param.paramData);\r\n");
      out.write("\t\t\t\t\t\t\t\t$(\"#itemeEditForm [name=itemParamId]\").val(data_param.id);\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t//回显商品规格\r\n");
      out.write("\t\t\t\t\t\t\t\t var paramData = JSON.parse(data_param.paramData);\r\n");
      ...
      out.write("        \t\t\t$.ajax({\r\n");
      out.write("        \t\t\t   type: \"POST\",\r\n");
      out.write("        \t\t\t   url: \"/rest/item/instock\",\r\n");
      out.write("        \t\t\t   data: params,\r\n");
      out.write("        \t\t\t   statusCode:{\r\n");
