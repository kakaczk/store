        		...
        		onLoad :function(){
        			...
        			$.ajax({
						...
						statusCode : {
							...
							200 : function(data_param) {
								$("#itemeEditForm .params").show();
								$("#itemeEditForm [name=itemParams]").val(data_param.paramData);
								$("#itemeEditForm [name=itemParamId]").val(data_param.id);
								
								//回显商品规格
								 var paramData = JSON.parse(data_param.paramData);
								 var html = "<ul>";
