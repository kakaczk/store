...
!function() {
    ...
    a.fn.Jlazyload = function(b, c) {
        if (this.length) {
            var d, e, f = a.extend({type: null,offsetParent: null,source: "data-lazyload",placeholderImage: "http://static.sundiromall.com/images/blank.gif",placeholderClass: "loading-style2",threshold: 200}, b || {}), g = this, h = function(a) {
...
var category = {OBJ: $("#_JD_ALLSORT"),
		URL_Serv: "http://manage.sundiromall.com/rest/item/cat/all?callback=category.getDataService",
